...
export function QueueFilters({
  ...
  return (
    ...
    >
      ...
      */}
      <div className="grid grid-cols-1 items-start gap-3 p-4 sm:grid-cols-[minmax(0,1fr)_minmax(11rem,14rem)] xl:grid-cols-[minmax(0,1fr)_minmax(11rem,14rem)_max-content_max-content]">
