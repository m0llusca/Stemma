...
export function WorkflowManagementPanel({ conversation, assignees }: WorkflowManagementPanelProps) {
  ...
  return (
    <section className="panel mb-6 p-5">
      <div className="mb-4">
        <h2 className="text-lg font-semibold">Управление проверкой</h2>
        <p className="mt-1 text-sm text-[#667085]">Назначение, статус и срок ручной QA-проверки.</p>
      </div>

      <form action={updateConversationWorkflow} className="grid gap-4 md:grid-cols-[minmax(160px,190px)_minmax(180px,1fr)_minmax(150px,180px)_auto]">
