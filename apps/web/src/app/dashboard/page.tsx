...
import { canAccessDashboard, queueFilterResetHref, roleHomePath } from "@/lib/auth/role-home";
...
async function DashboardPageContent() {
  ...
  return (
    ...
    >
      <WelcomeBackBanner resetHref={queueFilterResetHref(user.role, { name: user.name })} />
      <TriageStrip
        tone={triageTone}
