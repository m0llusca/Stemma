...
- Cert and operational step are not the same «Готовность». Cert badge = **«Сертификация»**; step badge = **«Шаг»**. OTRS diagnostics footer: **«Диагностика ≠ живая сертификация»** (`probe-honesty.ts`).
